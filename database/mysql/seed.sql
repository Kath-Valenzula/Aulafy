...
VALUES
  (
    ...
    'Por seguridad, la puerta secundaria permanecerá cerrada durante la salida.',
    'AVISO',
    1,
    1,
    1
  ...
  (
    ...
    'Revisar material adjunto y completar cuestionario para la próxima clase.',
    'TAREA',
    0,
    1,
    1
...
VALUES
  (
    ...
    'TELEGRAM_TEST',
    'NOT_CONFIGURED',
    'Mensaje de prueba Aulafy: integración Telegram operativa.',
    'NOT_CONFIGURED',
